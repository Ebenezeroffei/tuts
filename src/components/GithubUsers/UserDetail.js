            ...
            <section className='my-4'>
                {
                    ...
                    :   <section>
                            ...
                            <div className='text-center mt-10'>
                                <Link to='/github-users/' className='text-center inline-block bg-blue-500 border-2 border-blue-500 py-3 px-20 rounded hover:bg-white hover:text-blue-500 transition-all duration-150'>Go Back</Link>
                            </div>
                        </section>
                }
            </section>
